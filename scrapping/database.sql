...
CREATE TABLE IF NOT EXISTS `sql11489784`.`interia` (
...
CREATE TABLE IF NOT EXISTS `sql11489784`.`weatherChannel` (
  `id` INT  PRIMARY KEY auto_increment,
  `temperature` INT NULL,
  `wind` INT NULL,
  `humidity` INT NULL,
...
CREATE TABLE IF NOT EXISTS `sql11489784`.`avenue` (
  `id` INT  PRIMARY KEY auto_increment,
  `temperature` INT NULL,
  `wind` INT NULL,
  `humidity` INT NULL,
...
CREATE TABLE IF NOT EXISTS `sql11489784`.`onet` (
  `id` INT  PRIMARY KEY auto_increment,
  `temperature` INT NULL,
  `wind` INT NULL,
  `humidity` INT NULL,
...
CREATE TABLE IF NOT EXISTS `sql11489784`.`wp` (
  `id` INT  PRIMARY KEY auto_increment,
  `temperature` INT NULL,
  `wind` INT NULL,
  `humidity` INT NULL,
...
CREATE TABLE IF NOT EXISTS `sql11489784`.`metroprog` (
  `id` INT  PRIMARY KEY auto_increment,
  `temperature` INT NULL,
  `wind` INT NULL,
  `humidity` INT NULL,
